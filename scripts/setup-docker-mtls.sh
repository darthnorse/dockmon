...
echo ""
echo "To add this host in DockMon:"
echo "1. Copy certificate contents to paste into DockMon:"
echo "   cat $CERT_DIR/ca.pem         # Copy this for CA Certificate field"
echo "   cat $CERT_DIR/client-cert.pem # Copy this for Client Certificate field"
echo "   cat $CERT_DIR/client-key.pem  # Copy this for Client Key field"
echo ""
echo "2. In DockMon, add new host with:"
echo "   URL: tcp://$HOST_IP:2376"
echo "   Then paste the certificate contents into the respective fields"
echo ""
